...
void test_get_user_choice(void) {
    ...
    char snum[12];  // Buffer size large enough to hold any integer, including negative numbers and null terminator

    // Convert the integer choice to a string using snprintf
    snprintf(snum, sizeof(snum), "%d", choice);
